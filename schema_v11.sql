...
-- schema_v11.sql — Full Schema (fresh install)
-- Version: 11 (roadmap v17)
...
--   v11 → academic_years: added deleted_at column + soft-delete index
--          + perform_student_rollup: changed from UPDATE (move) to INSERT (copy)
--          + int_to_khmer + generate_next_grade_class_name helper functions
-- ============================================================
...
-- ------------------------------------------------------------
-- int_to_khmer
-- Helper: convert integer to Khmer digits for class name generation.
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- generate_next_grade_class_name
-- Given a class name like "ថ្នាក់ទី១ក", return "ថ្នាក់ទី២ក".
...
-- End-of-year: copies students grade N → N+1 (INSERT, not UPDATE)
...
-- ============================================================
-- DONE — schema_v11.sql
-- Fresh install covers all versions v1 → v11
