...
-- schema_v9.sql — Full Schema (fresh install)
-- Version: 9 (roadmap v14)
...
--   parent      → Anonymous (anon). Read-only via report link only.
--
...
-- Anon read: knowing the UUID is sufficient proof of access.
...
-- ============================================================
-- DONE — schema_v9.sql
-- Fresh install covers all versions v1 → v9
-- For upgrading existing installs: run migration_v8_v9.sql instead
-- ============================================================
